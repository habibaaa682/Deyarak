...
class RelatedSuggestionsRepoImpl implements RelatedSuggestionRepo {
  ...
  @override
  Future<Either<Failure, List<RelatedSuggestionModel>>> fetchRelatedSuggestion({required String propertyId})async {
    try {
      var data = await apiService.get(endPointPath: 'properties/related-suggestions/$propertyId');
