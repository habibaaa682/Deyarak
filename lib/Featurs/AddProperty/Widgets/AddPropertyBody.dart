...
// Radio_
          ...
          PropertyDiscription(
           ...
           Radio_(text: 'Finished :',textEditingController: addPropertyController.FinishedController),
           Radio_(text: 'Furnished :',textEditingController: addPropertyController.FurnishedController),
           Radio_(text: 'Elevator :',textEditingController: addPropertyController.ElevatorController),
//---------------------------------------------------------------------------------------------
// Divider 6
          const Divider_(),
//---------------------------------------------------------------------------------------------
